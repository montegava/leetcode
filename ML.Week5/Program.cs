...
using ML.Week5.search_a_2d_matrix_ii;
...
//new Solution().RemoveCoveredIntervals(new int[][] { [1, 2], [1, 4], [3, 4] });

new ML.Week5.least_number_of_unique_integers_after_k_removals.Solution().FindLeastNumOfUniqueInts(
    new[] { 4, 3, 1, 1, 3, 3, 2 }, 3);
